...
//  Project 29
//
//  Created by Julio Braganca on 06/07/23.
//
...
struct Wind {
    ...
    func getHorizontalGravity(player: Int, gravityModifier: Double) -> Double {
    ...
    func getVerticalGravity(gravityModifier: Double) -> Double {
    ...
    func getSpeedGravityModifier() -> Double {
